                        ...
                        children: [
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                const Text('Team Access', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AC.ink900)),
                                const SizedBox(height: 4),
                                const Text('Add new staff or manager profiles to the APMS system.', style: TextStyle(fontSize: 12, color: AC.ink400)),
                              ],
                            ),
                          ),
